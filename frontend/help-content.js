    ...
    },
    {
      ...
      steps: [
        ...
        },
        {
          ...
          text: 'Open Advanced Options for row-level BO, Recon File, or SQL compares. Keep Backend as pandas unless polars or duckdb is installed and validated. Use Float Tolerance for general numeric rounding, Per-column tolerances for fields like price or tax, Datetime Tolerance for timestamp drift, case-insensitive matching and whitespace normalization for non-material text differences, Sample Fraction for smoke checks, Mismatch Row Limit to cap stored detail, and Parallel column comparison for very wide tables.',
        ...
        },
        {
          ...
          where: 'Compare -> Multi-File',
          warn: 'The Compare tab Multi-File flow supports local sources only and runs pairs sequentially. Use a saved Multi-File reconciliation job for reusable or remote S3/SFTP workflows.',
        },
        {
