    ...
    },
    {
      ...
      steps: [
        ...
        },
        {
          ...
          text: 'Enforce quality gates in CI/CD pipelines with the atom CLI (atom run <selection-or-sequence> --target-type selection|sequence --source-env ...), which launches a Job Selection or Execution Sequence, waits for it, and exits non-zero on failure. On GitLab, scripts/ci/run-atom-target.sh wraps the same CLI and also posts the result as a commit status / merge-request comment. A ready-to-copy pipeline snippet for either target type is generated by the CI/CD button on the Launch and Sequences tabs.',
          where: 'CI/CD pipeline scripts (GitLab CI, GitHub Actions, Jenkins) / atom CLI',
