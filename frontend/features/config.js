  ...
  global.ETL_FEATURE_CONFIG = function () {
    ...
    openNewConfigModal() {
      this.configModal = {
        ...
        ds_url: '', ds_user: '', ds_password: '', ds_repository: '', ds_auth_type: 'secEnterprise', ds_cms_system: '', ds_timeout: 60,
